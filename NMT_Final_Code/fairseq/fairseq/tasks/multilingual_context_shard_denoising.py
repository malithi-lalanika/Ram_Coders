...
class MultilingualContextShardDenoisingTask(DenoisingTask):
    ...
    def add_args(parser):
        ...
        #parser.add_argument('--num-shards', type=int, default=1, required=True,help="specify how many shards for data in each language")
    @classmethod
    def setup_task(cls, args, **kwargs):
        """Setup the task.
        """
        args.data='/userdirs/ram_coders/DEEP/deep/data/Wikipedia/wiki-max512-deep-spm250000-bin'
