...
--restore-file /userdirs/ram_coders/DEEP/deep_si/outputs/pretrain/mbart50-pt-mbart-obj/checkpoint_best.pt \
...
--reset-optimizer \
--fp16 \
--save-dir /userdirs/ram_coders/DEEP/deep_si/outputs/pretrain/mbart50-pt-deep-obj > /userdirs/ram_coders/DEEP/deep_si/outputs/pretrain/mbart50-pt-deep-obj/logs 2>&1
