...
REPO=/userdirs/ram_coders/DEEP
bin_dir=$REPO/data/ted-bin/en_XX-uk_XX/ 
tl='uk_XX'
sl='en_XX'
V=250000
MODEL=$REPO/data/mbart.cc25.v2/sentence.bpe.model
DICT=$REPO/data/mbart.cc25.v2/dict.txt
langs='uk_XX'
...
PRETRAIN=$REPO/deep/outputs/pretrain/mbart-${langs}-batch${BS}x8-wiki-max${MAXL}-deep-spm250000/save/checkpoint_1_5000.pt
save_dir=$REPO/deep_ft/outputs/finetune/ted-enuk/mbart-${langs}-deep-uf32-mt2000-epoch5/


mkdir -p $save_dir/runs
echo "save_dir=$save_dir"
python $REPO/deep_ft/fairseq/fairseq_cli/train.py $bin_dir \
    --save-dir $save_dir \
