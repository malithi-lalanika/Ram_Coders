REPO=/userdirs/ram_coders/DEEP/deep
MAXL=512
...
while : 
do
python $REPO/fairseq/train-gpu.py \
$DATA \
...
--sentencepiece-model /userdirs/ram_coders/DEEP/data/mbart.cc25.v2/sentence.bpe.model # 2> $OUTDIR/err 
